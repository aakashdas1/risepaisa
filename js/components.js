...
function renderNavbar(currentPath) {
  ...
  const pc = navCfg.personalAdvice || {};
  ...
  // Insert Personal Advice (admin-togglable)
  if (pc.enabled !== false) {
    links.push({ path: pc.path || '#/consultancy', label: pc.label || 'Personal Advice' });
  }
  ...
  const authArea = _loggedIn
    ...
    : `<div class="nav-auth-area">
         ...
         <a href="https://wa.me/${getSettings().whatsapp}?text=${encodeURIComponent('I want to contact you.')}" target="_blank" rel="noopener" class="btn btn-primary nav-cta">
  ...
  const mobileAuth = _loggedIn
    ...
    : `<div class="mobile-cta">
         ...
         <a href="https://wa.me/${getSettings().whatsapp}?text=${encodeURIComponent('I want to contact you.')}" target="_blank" rel="noopener" class="btn btn-whatsapp btn-lg" style="width:100%">
  ...
  return `
    <nav class="navbar" id="navbar">
      <div class="navbar-inner">
        ...
        <!-- Mobile CTA Buttons (visible only on mobile, replaces login) -->
        <div class="mobile-cta-buttons" id="mobile-cta-buttons">
          <a href="#/courses" class="mobile-cta-btn ${currentPath === '#/courses' ? 'active' : ''}">Courses</a>
          <a href="#/consultancy" class="mobile-cta-btn ${currentPath === '#/consultancy' ? 'active' : ''}">Personal Advice</a>
          <a href="#/resources" class="mobile-cta-btn ${currentPath === '#/resources' ? 'active' : ''}">Resources</a>
        </div>
