        ...
        <div class="founder-section about-founder-premium">
          ...
          <div class="founder-info">
            ...
            <div class="founder-actions">
              <a href="https://wa.me/${getWhatsApp()}?text=${encodeURIComponent('I want to connect with you and know more about you.')}" target="_blank" rel="noopener" class="btn btn-whatsapp founder-cta-btn">
