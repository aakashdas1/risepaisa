...
// ==============================================
import { getCourses, getSettings } from '../admin/store.js';
...
export function renderCourseDetailPage(slug) {
  ...
  const waLink    = `https://wa.me/${WHATSAPP_NUMBER}?text=I want to buy the course: ${encodeURIComponent(course.title)}`;
  const waAskLink = `https://wa.me/${WHATSAPP_NUMBER}?text=I have a question about the course: ${encodeURIComponent(course.title)}`;
  ...
  const estimatedHours = Math.max(3, Math.round(totalLessons * 0.25));
          ...
          <div class="cd-sidebar">
            <div class="cd-pricing-card" id="pricing-card">
              ...
              <div class="cd-price-labels">
                ...
                <span class="cd-label-item">Certificate included</span>
              </div>
